    ...
    (function (Ui) {
        Ui.AnalyticsActionCauseList = {
            ...
            omniboxAnalytics: {
                ...
                type: 'omnibox',
                metaMap: { partialQuery: 1, suggestionRanking: 2 }
            },
            omniboxField: {
                name: "omniboxField",
                type: 'omnibox'
    ...
    (function (Controllers) {
        var HistoryController = (function (_super) {
            ...
            function HistoryController(element, _window, model, queryController) {
                ...
                Coveo.$(this.element).on(this.model.getEventName(Coveo.Models.Model.eventTypes.all), function () { return _this.updateHashFromModel(); });
...
(function (Coveo) {
    ...
    (function (Controllers) {
        ...
        var QueryController = (function (_super) {
            ...
            QueryController.prototype.loadLastQuery = function () {
                var lastQuery = new Coveo.LocalStorageUtils('lastQuery').load();
                if (lastQuery != null && new Date().getTime() <= lastQuery.expire) {
                    this.lastQuery = lastQuery.lastQuery;
                    this.lastSearchUid = lastQuery.lastSearchUid;
                }
            };
            QueryController.prototype.saveLastQuery = function () {
                new Coveo.LocalStorageUtils('lastQuery').save({
                    expire: new Date().getTime() + 1000 * 60 * 30,
                    lastQuery: this.lastQuery,
                    lastSearchUid: this.lastSearchUid
                });
            };
            QueryController.prototype.executeQuery = function (options) {
                ...
                deferredFromEndpoint.done(function (queryResults) {
                    ...
                    if (_this.keepLastSearchUid(query)) {
            ...
            QueryController.prototype.keepLastSearchUid = function (newQuery) {
                var queryA = Coveo._.omit(this.getLastQuery(), 'firstResult', 'groupBy', 'debug');
                var queryB = Coveo._.omit(newQuery, 'firstResult', 'groupBy', 'debug');
    ...
    (function (Ui) {
        var SearchInterface = (function (_super) {
            ...
            SearchInterface.prototype._initializeAnalytics = function () {
                ...
                if (analyticsRef) {
                    return analyticsRef.makeSingleton(this.element, this.analyticsOptions);
                }
            ...
            SearchInterface.options = {
                ...
                pipeline: Ui.ComponentOptions.buildStringOption({ defaultValue: 'default' })
            };
    ...
    (function (Ui) {
        var OmniBox = (function (_super) {
            ...
            function OmniBox(element, options, bindings) {
                ...
                Coveo.$("body").fastClick(function (e) {
        ...
        var TopAnalyticsSuggestions = (function (_super) {
          ...
          <%= data %> \
            ...
            TopAnalyticsSuggestions.prototype.onRowSelection = function (value, args) {
                ...
                args.closeOmniBox();
                this.queryStateModel.set(Coveo.Models.QueryStateModel.attributesEnum.q, value);
                var suggestionRanking = Coveo._.indexOf(Coveo._.pluck(this.resultsToBuildWith, 'value'), value);
                this.queryController.deferExecuteQuery({ beforeExecuteQuery: function () {
                    ...
                    _this.usageAnalytics.logCustomEvent(Ui.AnalyticsActionCauseList.omniboxAnalytics, { partialQuery: args.currentQueryExpression.word, suggestionRanking: suggestionRanking }, _this.element);
                } });
            };
